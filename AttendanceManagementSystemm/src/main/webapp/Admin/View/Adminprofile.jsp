...
<div id="mytask-layout" class="theme-indigo">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#stud-Components" href="#"><i
                            class="fa fa-graduation-cap"></i> <span>Student</span> <i class="fa fa-arrow-right" style=" padding-left: 20px ;font-size:18px"></i> </a>
                    <!-- Menu: Sub menu ul -->
    ...
    <div class="main px-lg-4 px-md-4">
                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        ...
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                            <div class="u-info me-2">
                                <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold">${Admin.getFirstName()} ${Admin.getLastName()}</span></p>
                            </div>
                                ...
                                <div class="card border-0 w280">
                                    <div class="card-body pb-0">
                                        <div class="d-flex py-1">
                                            <img class="avatar rounded-circle" src="Admin/assets/images/profile_av.png" alt="profile">
                                            <div class="flex-fill ms-3">
                                                <p class="mb-0"><span class="font-weight-bold">${Admin.getFirstName()} ${Admin.getLastName()}</span></p>
                                                <small class="">${Admin.getEmail()}</small>
                                            </div>
                                        </div>
        ...
        <c:choose >
        <c:when test="${Instructors}">
        <jsp:include page="/Admin/View/Instructors.jsp" />
        </c:when>
        <c:when test="${InstructorProfile}">
              <jsp:include page="/Admin/View/InstructorProfile.jsp" />
        </c:when>
        <c:when test="${Students}">
            <jsp:include page="/Admin/View/Students.jsp" />
        </c:when>

        <c:when test="${StudentProfile}">
             <jsp:include page="/Admin/View/StudentProfile.jsp" />
        </c:when>
        <c:when test="${Courses}">
          <jsp:include page="/Admin/View/Courses.jsp" />
        </c:when>
        <c:when test="${CourseInfo}">
                     <jsp:include page="/Admin/View/CourseInfo.jsp" />
        </c:when>
        ...
        <c:otherwise>
         <jsp:include page="/Admin/View/welcome.jsp" />
        </c:otherwise>
