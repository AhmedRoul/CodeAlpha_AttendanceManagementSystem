...
<c:choose>
    ...
    <c:otherwise>
       <div class="alert alert-danger" role="alert">
        ...
        <form action="/AttendanceManagementSystemm/Instructor?InstructorPageInfo=true" method="post" >
            <div class="form-group">
                <label for="firstName">First Name</label>
                <input type="text" class="form-control"  name="firstName" id="firstName"

                 value="${instructorData.getFirstName()}" >
              </div>
              <div class="form-group">
                <label for="lastName">Last Name</label>
                <input type="text" class="form-control" id="lastName" name="lastName"
                 value="${instructorData.getLastName()}" >
              </div>
              <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email"
                value="${instructorData.getEmail()}" readonly>
              </div>
              <div class="form-group">
                <label for="username">Username</label>
                <input type="text" class="form-control" id="username"
                value="${instructorData.getUsername()}" readonly>
              </div>

              <div class="form-group">
                <label for="birthday">Birthday</label>
                <input type="date" class="form-control" id="birthday" name="birthday"
                value="${instructorData.getBirthday()}" readonly>
              </div>
              <div class="form-group">
                <label for="details">Details</label>
                <textarea class="form-control" id="details" name="details" rows="3">
                ${instructorData.getDetails()}
                </textarea>
              </div>
              <div class="form-group">
            ...
            value="${instructorData.getId()}" class="btn btn-primary">Save Changes</button>
        </form>
    </div>
